  ...
  void exporter({
    ...
    for (final ligne in lignes) {
      ...
      final row = <excel_pkg.CellValue>[
        ...
        excel_pkg.TextCellValue(c['typeEquipement1']?.toString() ?? ''),
        excel_pkg.TextCellValue(c['typeEquipement2']?.toString() ?? ''),
        excel_pkg.TextCellValue(c['typeEquipement3']?.toString() ?? ''),
