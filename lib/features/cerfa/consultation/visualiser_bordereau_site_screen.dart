...
import 'visualiser_bordereau_equipement_screen.dart';

class VisualiserBordereauSiteScreen extends StatelessWidget {
  final String client;
  final List<Equipement> equipements;

  const VisualiserBordereauSiteScreen({
    super.key,
  ...
  void _ouvrirSite(BuildContext context, String site) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => VisualiserBordereauEquipementScreen(
          client: client,
          site: site,
